...
class DBHelper:
    ...
    def fetch_request(self,user_id):
        self._mycursor.execute("""SELECT *  FROM proposals p JOIN users u
    ...
    def register(self, name, email, password, age, gender, city, dp,about):

        try:

            self._mycursor.execute("""
                                                        INSERT INTO users (user_id,name,email,password,age,gender,city,dp,about)
                                                        VALUES
                                                        (NULL, '{}','{}','{}',{},'{}','{}','{}','{}')
    """.format(name, email, password, age, gender, city, dp,about))
